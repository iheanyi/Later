 ...
 */
public class SwipeMessageAdapter extends ArrayAdapter<MessageModel> {
    ...
    public SwipeMessageAdapter(Context context) {
        super(context, R.layout.swipelistview);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = inflater.inflate(R.layout.swipelistview, null);
